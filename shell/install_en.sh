...
dokodemoDoorUnblockNetflix() {
	...
	echoContent red "\n=============================================================="
	echoContent yellow "# Precautions"
	echoContent yellow "Any door unlock detailed, please check this article[https://github.com/W-KE/v2ray-agent/blob/master/documents/netflix/dokodemo-unblock_netflix.md]\n"
